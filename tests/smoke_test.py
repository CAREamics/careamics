...
@pytest.fixture
def base_configuration(temp_dir, example_data):
    train_dir, val_dir = example_data
...
@pytest.fixture
def predict_configuration(base_configuration):
    predict_configuration = base_configuration.model_copy()
    workdir = predict_configuration.working_directory
    model_name = f'{predict_configuration.experiment_name}_best.pth'
    predict_configuration.trained_model = workdir / model_name
    return predict_configuration
...
def test_is_engine_runnable(base_configuration):
    """
