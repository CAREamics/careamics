...
class TestAdvancedCAREConfig:
    ...
    @pytest.mark.parametrize(
        "axes, n_channels_in, n_channels_out, channels, target_axes, error",
        [
            # Valid cases
            ("YX", None, None, None, None, False),
            ("YX", 1, None, None, None, False),
            ("YX", 1, 1, None, None, False),
            ("YX", 1, 2, None, "CYX", False),
            ("YX", None, 2, None, "CYX", False),
            ("CYX", 1, None, None, None, False),
            ("CYX", 1, 1, None, None, False),
            ("CYX", 1, None, [0], None, False),
            ("CYX", 1, 1, [0], None, False),
            ("CYX", 3, None, None, "CYX", False),
            ("CYX", 3, 3, [0, 2, 3], "CYX", False),
            ("CYX", 3, 2, [0, 2, 3], "CYX", False),
            # no channels allowed
            ("YX", None, None, [0], None, True),
            ("YX", 2, None, None, None, True),
            ("YX", 2, 1, None, None, True),
            ("YX", 1, 2, None, None, True),
            ("YX", None, 2, None, None, True),
            ("YX", 1, 2, None, "YX", True),
            # mismatched channels
            ("YX", 1, None, [0, 2], None, True),
            ("YX", 1, 2, [0, 2], "CYX", True),
            ("YX", 3, None, [0, 2], "CYX", True),
            ("YX", 3, 1, [0, 2], None, True),
        ],
    )
    def test_channels(
        self, axes, n_channels_in, n_channels_out, channels, target_axes, error
    ):
        ...
        if error:
            ...
            assert config.data_config.target_axes == target_axes
