...
WriteTilesZarr = pd_writer.WriteTilesZarrTS
_auto_chunks = pd_writer.write_tiles_zarr_ts_strategy._auto_chunks
_update_data_shape = pd_writer.write_tiles_zarr_ts_strategy._update_data_shape
