...
@pytest.mark.parametrize(
    ...
    [
        (1, (16, 16), "YX", (1, 1, 16, 16)),
        (1, (3, 16, 16), "CYX", (1, 3, 16, 16)),
        (1, (8, 16, 16), "ZYX", (1, 1, 8, 16, 16)),
        (1, (3, 8, 16, 16), "CZYX", (1, 3, 8, 16, 16)),
        (1, (4, 16, 16), "SYX", (1, 1, 16, 16)),
        (1, (4, 3, 16, 16), "SCYX", (1, 3, 16, 16)),
        (1, (4, 3, 8, 16, 16), "SCZYX", (1, 3, 8, 16, 16)),
        (3, (16, 16), "YX", (1, 1, 16, 16)),
        (3, (3, 16, 16), "CYX", (1, 3, 16, 16)),
        (3, (8, 16, 16), "ZYX", (1, 1, 8, 16, 16)),
        (3, (3, 8, 16, 16), "CZYX", (1, 3, 8, 16, 16)),
        (3, (4, 16, 16), "SYX", (1, 1, 16, 16)),
        (3, (4, 3, 16, 16), "SCYX", (1, 3, 16, 16)),
        (3, (4, 3, 8, 16, 16), "SCZYX", (1, 3, 8, 16, 16)),
    ],
)
