...
array_root_1 = zarr_file.create_array("root_array_1", data=np.random.rand(128, 128))
array_root_2 = zarr_file.create_array("root_array_2", data=np.random.rand(128, 128))
...
train_from_array = str(array_root_1.store_path)  # (2)!
train_from_group = str(group.store_path)  # (3)!
train_from_list = [
    str(array_root_1.store_path),  # (4)!
    str(array_root_2.store_path),  # (5)!
    str(array_2.store_path),  # (6)!
    str(array_3.store_path),  # (7)!
]
# --8<-- [end:zarr]
