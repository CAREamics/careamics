...
def default_training_dict(
    algorithm: Literal["care", "n2n", "n2v", "hdn", "microsplit"],
    ...
    Parameters
    ----------
    algorithm : {"care", "n2n", "n2v", "hdn", "microsplit"}
...
def default_training_factory(validated_dict: dict[str, Any]) -> TrainingConfig:
    """Default training configuration constructor.
