...
class N2V2Description(AlgorithmDescription):
    ...
    description: str = "N2V2 is a variant of Noise2Void. " + N2V_DESCRIPTION + \
...
class StructN2VDescription(AlgorithmDescription):
    ...
    description: str = "StructN2V is a variant of Noise2Void. " + N2V_DESCRIPTION + \
...
class StructN2V2Description(AlgorithmDescription):
    ...
    description: str = "StructN2V2 is a a variant of Noise2Void that uses both " \
                "structN2V and N2V2. "+ N2V_DESCRIPTION + \
